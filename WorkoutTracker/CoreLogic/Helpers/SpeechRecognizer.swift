...
//  WorkoutTracker
//
//  Created by Boris Serzhanovich on 20.04.26.
//
...
final class SpeechRecognizer: ObservableObject {
    ...
    func startTranscribing() {
        ...
        do {
            ...
            request.shouldReportPartialResults = true // Текст будет обновляться в реальном времени
    ...
    func stopTranscribing() {
        ...
        // Возвращаем аудио сессию в нормальное состояние (чтобы музыка снова заиграла громко)
