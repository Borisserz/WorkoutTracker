    ...
    public var routines: [LegendaryRoutine] {
        [
            ...
            LegendaryRoutine(
                ...
                gradientColors: [Color(hex: "F5AF19"), Color(hex: "F12711")], 
                difficulty: .advanced,
                estimatedMinutes: 75,
            ...
            LegendaryRoutine(
                ...
                gradientColors: [Color(hex: "4B1248"), Color(hex: "F0C27B")], 
            ...
            LegendaryRoutine(
                ...
                gradientColors: [Color(hex: "000000"), Color(hex: "434343"), Color.red.opacity(0.8)], 
                difficulty: .advanced,
                estimatedMinutes: 45,
            ...
            LegendaryRoutine(
                ...
                gradientColors: [Color(hex: "00C9FF"), Color(hex: "92FE9D")], 
                difficulty: .intermediate,
                estimatedMinutes: 65,
                ...
                exercises: [
                    ...
                    ex("Plank", group: "Core", type: "Duration", sets: 3, reps: 60) 
                ]
            ),
            ...
            LegendaryRoutine(
                ...
                gradientColors: [Color(hex: "114357"), Color(hex: "F29492")], 
                difficulty: .advanced,
                estimatedMinutes: 50,
