...
struct WorkoutHubView: View {
    ...
    @State private var featuredPrograms: [WorkoutProgramDefinition] = []
    ...
    private var fallbackPrograms: [WorkoutProgramDefinition] {
        [
            WorkoutProgramDefinition(
                ...
                gradientColors: [.purple, .blue], isSingleRoutine: false, routines: []
            ),
            WorkoutProgramDefinition(
                title: "Shred Core",
                ...
                gradientColors: [.orange, .red], isSingleRoutine: false, routines: []
            ),
            WorkoutProgramDefinition(
                ...
                gradientColors: [.cyan, .green], isSingleRoutine: false, routines: []
            )
        ]
    }
    ...
    var body: some View {
        NavigationStack {
            ...
            .task {
                ...
                var progs = Array(FirestoreProgramService.shared.explorePrograms.prefix(5))
                if progs.isEmpty {
                    progs = fallbackPrograms
                }
                featuredPrograms = progs
            }
        }
    }
