    ...
    private var fallbackPrograms: [WorkoutProgramDefinition] {
        [
            WorkoutProgramDefinition(
                title: "AI Muscle Growth",
                description: "A tailored 12-week hypertrophy program generated by AI.",
                level: .advanced, goal: .buildMuscle, equipment: .fullGym,
                gradientColors: [.purple, .blue], isSingleRoutine: false,
                routines: [
                    fallbackRoutine("Push Day", "img_chest", [
                        fallbackEx("Barbell Bench Press - Medium Grip", "Chest", 4, 8),
                        fallbackEx("Standing Military Press", "Shoulders", 3, 10),
                        fallbackEx("Triceps Pushdown", "Arms", 3, 12)
                    ]),
                    fallbackRoutine("Pull Day", "img_back", [
                        fallbackEx("Pullups", "Back", 4, 8),
                        fallbackEx("Bent Over Barbell Row", "Back", 3, 10),
                        fallbackEx("Barbell Curl", "Arms", 3, 12)
                    ]),
                    fallbackRoutine("Legs Day", "img_legs", [
                        fallbackEx("Barbell Squat", "Legs", 4, 8),
                        fallbackEx("Leg Press", "Legs", 3, 12),
                        fallbackEx("Standing Barbell Calf Raise", "Legs", 4, 15)
                    ])
                ]
            ),
            WorkoutProgramDefinition(
                title: "Shred Core",
                description: "Burn fat and build a strong core with this high-intensity program.",
                level: .intermediate, goal: .loseWeight, equipment: .dumbbells,
                gradientColors: [.orange, .red], isSingleRoutine: false,
                routines: [
                    fallbackRoutine("Core Shred A", "img_default", [
                        fallbackEx("Crunch", "Core", 3, 15),
                        fallbackEx("Plank", "Core", 3, 60),
                        fallbackEx("Hanging Leg Raise", "Core", 3, 12)
                    ]),
                    fallbackRoutine("Core Shred B", "img_default", [
                        fallbackEx("Russian Twist", "Core", 3, 20),
                        fallbackEx("Ab Wheel Rollout", "Core", 3, 10),
                        fallbackEx("Bicycle Crunches", "Core", 3, 15)
                    ])
                ]
            ),
            WorkoutProgramDefinition(
                title: "Beginner Basics",
                description: "Start your fitness journey the right way with fundamentals.",
                level: .beginner, goal: .getStronger, equipment: .bodyweight,
                gradientColors: [.cyan, .green], isSingleRoutine: false,
                routines: [
                    fallbackRoutine("Full Body A", "img_default", [
                        fallbackEx("Bodyweight Squat", "Legs", 3, 15),
                        fallbackEx("Pushups", "Chest", 3, 10),
                        fallbackEx("Assisted Pullups", "Back", 3, 8)
                    ]),
                    fallbackRoutine("Full Body B", "img_default", [
                        fallbackEx("Bodyweight Lunge", "Legs", 3, 10),
                        fallbackEx("Dumbbell Shoulder Press", "Shoulders", 3, 10),
                        fallbackEx("Dumbbell Curl", "Arms", 3, 12)
                    ])
                ]
            )
        ]
